...
| `CCH_Data_Pipeline/` | Kotlin | Pipeline xử lý dữ liệu camera giao thông (aggregator, smoother, modeler) |
...
| `crates/hanoi-core/src/line_graph.rs` | Line graph (turn-expanded) routing, spatial indexing, snap-to-edge |
...
| File | Vai trò |
|------|---------|
| `crates/hanoi-server/src/main.rs` | Axum HTTP server, endpoint routing |
